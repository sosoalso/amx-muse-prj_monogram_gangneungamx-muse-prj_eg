...
class UIVidswt:
    PVW_BUTTONS = [101, 102, 103, 104, 105, 106, 107, 108, 109, 110]
    PGM_BUTTONS = [201, 202, 203, 204, 205, 206, 207, 208, 209, 210]
    CUT_BUTTON = 50
    AUTO_BUTTON = 51
